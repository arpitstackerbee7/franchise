...
def get_data(filters):
	...
	# Ensure all filter keys exist to prevent KeyErrors
	filters.setdefault("company", "")
	filters.setdefault("supplier", "")
	filters.setdefault("item_code", "")
	filters.setdefault("barcode", "")

	# Note the '%%' in the LIKE clauses below - this is the fix for your error
	sql_query = """
		SELECT
			...
			item.custom_silvet AS "Section:Data:120",
			item.custom_departments AS "Department:Data:120",
			item.item_name AS "Article Name:Data:150",
