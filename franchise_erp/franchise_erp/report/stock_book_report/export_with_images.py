...
from franchise_erp.franchise_erp.report.stock_book_report.stock_book_report import (
    get_columns,
    get_data,
)
...
@frappe.whitelist()
def export_stock_book_with_images(filters=None):
    ...
    file_name = f"stock_book_report_{frappe.utils.now_datetime().strftime('%Y%m%d_%H%M%S')}.xlsx"
