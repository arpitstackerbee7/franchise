...
frappe.ui.form.CustomerQuickEntryForm = class CustomerQuickEntryForm extends frappe.ui.form.QuickEntryForm {
    ...
    render_dialog() {
        ...
        const set_company_logic = (company) => {
            ...
            frappe.call({
                ...
                callback: (r) => {
                    ...
                    const disable_validation =
                        r?.message?.custom_disable_validation_for_counter || 0;

                    // -------------------------
                    // MOBILE REQUIRED LOGIC
                    // -------------------------
                    mobile_field.df.reqd = is_group ? 0 : 1;
                    mobile_field.refresh();
                    ...
                    if (disable_validation) {
                        this.dialog.set_value("customer_group", "Retail");
                    } else {
                        this.dialog.set_value("customer_group", "");
                    }
        ...
        // Dialog load
        set_company_logic(company_field.get_value());
