(function () {
    ...
    function renderCompanyBadge() {
    // 1️⃣ Logged-in user ki CURRENT session company
    const company =
    ...
    // 2️⃣ Navbar search / awesome bar
    const searchContainer = document.querySelector(
        ".search-bar, .navbar-search, .awesome-bar"
    );
    ...
    badge.innerHTML = `🏢 ${company}`;

    // Awesome bar ke left side insert
    searchContainer.parentElement.insertBefore(badge, searchContainer);

    console.log("✅ Session Company Badge:", company);
}
