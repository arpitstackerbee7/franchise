...
# def on_submit_material_receipt(doc, method):
...
#         if item.custom_material_issue_id:
#             material_issue_map.setdefault(
#                 item.custom_material_issue_id, []
#             ).append(item.custom_material_issue_item_id)

#             # mark child row as received
#             frappe.db.set_value(
#                 "Stock Entry Detail",
#                 item.custom_material_issue_item_id,
#                 "custom_material_receipt_id_",
#                 doc.name
#             )

#     for issue_id in material_issue_map:
#         pending = frappe.db.exists(
#             "Stock Entry Detail",
#             {
#                 "parent": issue_id,
#                 "custom_material_receipt_id_": ["in", ["", None]]
#             }
#         )
...
#             issue_id,
#             "custom_status",
#             "Partially Delivered" if pending else "Delivered"
#         )
