...
def validate_overdue_invoice(doc, method):
    ...
    # ===============================
    # CREDIT LIMIT LOGIC (NEW)
    # ===============================
    available_credit = flt(credit_limit) - flt(outstanding)

    credit_limit_failed = False
    if flt(doc.grand_total) > available_credit:
